...
public class MateriaRepositoryQueryImpl implements MateriaRepositoryQuery {
	...
	public List<Materia> filtrar(MateriaFilter filter) {
		...
		String sql = montarQuery(clausulasWhere, parametros, filter, "m");
	...
	public List<String> buscarNomes(MateriaFilter filter) {
		List<String> clausulasWhere = new ArrayList<>();
		Map<String, Object> parametros = new HashMap<>();
		String sql = montarQuery(clausulasWhere, parametros, filter, "m.nome");
	...
	private String montarQuery(List<String> clausulasWhere, Map<String, Object> parametros, MateriaFilter filter, String select) {
		final StringBuffer sql = new StringBuffer();
		sql.append("SELECT DISTINCT ").append(select).append(" FROM Materia m ");
